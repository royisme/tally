...
<template>
    <div v-if="column.getCanSort()" :class="cn('flex items-center space-x-2', $attrs.class as string)">
        <DropdownMenu>
    ...
    <div v-else :class="cn('flex items-center space-x-2', $attrs.class as string)">
        {{ title }}
    </div>
</template>
